...
![Creating folder](/Pictures/image.png)
...
![Enabling sharing on the network](/Pictures/image-8.png)
Here you can see the shared path to the folder.
![Shared folder](/Pictures/image-2.png)
...
![Creating a subfolder named HR inside Company Data folder](/Pictures/image-3.png)
...
![Creating a new user](/Pictures//Pictures/image-4.png)
...
![Creating the user Jim](/Pictures/image-5.png)
...
![Creating a new group](/Pictures/image-6.png)
...
![Adding Jim to the Security Group](/Pictures/image-7.png)
...
![Permissions for Company Data](/Pictures/image-9.png)
...
![Adding HR Security Group to Permissions for Company Data](/Pictures/image-10.png)
...
![Disabling inheritance](/Pictures/image-11.png)
...
![Removing inheritance](/Pictures/image-12.png)
...
![Adding HR and setting NTFS permissions](/Pictures/image-14.png)
...
![Setting the NTFS permissions on the HR subfolder](/Pictures/image-15.png)
...
![Listing the Windows Update service](/Pictures/image-16.png)
...
![Listing SID of Jim](/Pictures/image-17.png)
...
![Listing HR group and it's SID](/Pictures/image-18.png)
